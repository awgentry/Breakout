--[[
	...
	Author: Adam Gentry
	6/25/23
	-spawn locked brick on 5% of all bricks - unlocked/breakable by key powerup
...
function LevelMaker.createMap(level)
    ...
    for y = 1, numRows do
        ...
        for x = 1, numCols do
			...
			-- NEW - add lock brick 10% of the time
            local rnd = math.random(1, 20)
			if rnd > 19 then	    
				b.color = 6
				b.tier = 3
				unlocked = 0   -- NEW - locked brick exists, need key powerup
			end    

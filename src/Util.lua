--[[
    ...
    Author: Adam Gentry
    6/19/23
    -added function to generate Powerup quads
...
function GenerateQuadsBricks(atlas)			-- NEW: change 21 to 24 to allow black and lock bricks
...
-- NEW - generate Powerup quads - based on ball quads
function GenerateQuadsPowerups(atlas)
    local x = 0     -- start here on spritesheet
    local y = 192

    local counter = 1
    local quads = {}

    for i = 0, 9 do   -- 10 powerups;                          coords, width, height, full sheet

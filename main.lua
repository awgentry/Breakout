--[[
	...
	-added placeholder high score names
...
--[[
	...
	called 'breakout', e.g., Windows: C:\Users\[username]\AppData\Roaming\LOVE
]]
function loadHighScores()
	...
	if not love.filesystem.getInfo('breakout.lst') then
		...
		local defaultScores = {'AWG', 'BY', 'T', 'U', 'O', 'K', 'A', 'E', 'R', 'B'}    -- NEW - placeholder high scores
		local scores = ''
		for i = 10, 1, -1 do
			scores = scores .. defaultScores[i] .. '\n'
...
function displayFPS()
	...
	-- NEW: optional programmer statistics (off)
	if debug == 1 then
	love.graphics.print('PowerTimer: ' .. tostring(powerTimer), 5, 15)
		love.graphics.print('NumBalls: ' .. tostring(numBalls), 5, 25)
		love.graphics.print('Multi: ' .. tostring(multi), 5, 35)
	end
